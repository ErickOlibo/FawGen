//
//  TEOGrowingTextView.swift
//  FawGen
//
//  Created by Kenneth Tsang on 17/2/2016.
//  Copyright (c) 2016 Kenneth Tsang. All rights reserved.
//
//  Created by Erick Olibo on 23/06/2019.
//  Copyright © 2019 DEFKUT Creations OU. All rights reserved.
//  Change few things to suit my App

import UIKit

@objc public protocol TEOGrowingTextViewDelegate: UITextViewDelegate {
    @objc optional func textViewDidChangeHeight(_ textView: TEOGrowingTextView, height: CGFloat)
}

//@objc
open class TEOGrowingTextView: UITextView {
    ...
    override open func layoutSubviews() {
        ...
        if height != heightConstraint!.constant {
            ...
            if let delegate = delegate as? TEOGrowingTextViewDelegate {
    ...
    @objc func textDidEndEditing(notification: Notification) {
        if let sender = notification.object as? TEOGrowingTextView, sender == self {
